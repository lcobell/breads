...
//model defined argument one is the bread var, the schema to follow is argument 2
const Bread = mongoose.model("Bread", breadSchema);

//have to export it if you want to use it!  make sure to export the model, not the schema
